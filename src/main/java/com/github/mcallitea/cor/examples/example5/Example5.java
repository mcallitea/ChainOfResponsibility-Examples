package com.github.mcallitea.cor.examples.example5;
...
import com.github.mcallitea.cor.examples.example5.corelements.CustomInterface;
...
public class Example5 {
    ...
    public static void main(String[] args) {
        ...
        example5.executeChainOfResponsibility("Drax");
        example5.executeChainOfResponsibility("Groot");
    }
    ...
    private void initChainOfResponsibility() {
        ...
        try {
            this.firstElement = AnnotationCorBuilder.buildChainOfResponsibility("com.github.mcallitea.cor.examples.example5.corelements");
